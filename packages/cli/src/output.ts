...
const BIDI_CONTROL_PATTERN = new RegExp(String.raw`[\u061c\u200e\u200f\u202a-\u202e\u2066-\u2069]`, 'gu')
...
export const sanitizeTerminalField = (value: string): string => sanitizeTerminalText(value)
  .replace(/[\r\n\t]+/gu, ' ')
  .replace(/ {2,}/gu, ' ')
  .trim()

export const printResult = (value: unknown, json: boolean, human: (value: unknown) => string): void => {
